...
id: 401
datetime: 2015-07-26 01:00:24.641617 +0000 UTC
...
So, there is this "tradition" at the [Recurse Center](https://www.recurse.com/) to write a "return statement". I figured before I delved into mine, I would explain what that means. The "recurse" in Recurse Center is a reference to [recursive functions](https://en.wikipedia.org/wiki/Recursion_%!c(MISSING)omputer_science%!)(MISSING). Wikipedia has a decent description of what recursion is, but I'll give an example nonetheless:
